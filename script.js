    // Adicione um novo event listener para o botão de assinar no footer
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (btnAssinarFooter) {
            btnAssinarFooter.addEventListener('click', () => {
                const email = newsletterInputFooter.value;
                if (email && email.includes('@') && email.includes('.')) {
                    showToast('Newsletter', `Obrigado por assinar, ${email}!`);
                    newsletterInputFooter.value = ''; // Limpa o campo
                } else {
                    showToast('Erro', 'Por favor, insira um e-mail válido.');
                }
            });
        }
    }); 
        document.addEventListener('DOMContentLoaded', () => {
                ...
                <div id="info-pix">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <textarea id="pix-code" class="form-control form-control-custom pix-code-container" rows="3" readonly>asdfgHJKLKJHGfdsaLKJHGfdsasdfghJHGfdsasdfghjklÇKJHGfdsaKLJHGfdsasdfghjklÇlkjhgfdsasdfghjklçkjhgfdsasdfghjklçasdfghjklç
</textarea>
            ...
            function showPage(pageId, bookId = null) {
                ...
                } else if (pageId === 'pedidos') {
                    // A página de pedidos é estática, não precisa de renderização dinâmica aqui
                }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    themeToggleButton.addEventListener('click', () => {
        // Toggle the 'purple-theme' class on the body
    ...
    // Existing event listeners for page navigation and search...
});
